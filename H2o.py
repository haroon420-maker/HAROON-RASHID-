...
os.system('clear')
os.system('xdg-open https://chat.whatsapp.com/IVmUmo9L9VV4WpwBk3ZMJX?mode=gi_t')
os.system('xdg-open https://chat.whatsapp.com/IVmUmo9L9VV4WpwBk3ZMJX?mode=gi_t')

import os, sys

# Tumhara WhatsApp channel link
channel_link = "https://chat.whatsapp.com/IVmUmo9L9VV4WpwBk3ZMJX?mode=gi_t"

# Valid keys (channel par available hogi)
approved_keys = ["AHB-HAROON-KEY-2026"]
